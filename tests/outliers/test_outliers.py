...
from bdacore.outliers import CovarianceOutliers, GaussianProcessOutliers
from bdacore.outliers import GMMOutliers, ClusteringOutliers
from bdacore.outliers import KMeansOneClusterOutliers, KMeansIterativeOneClusterOutliers
from bdacore.outliers import MADOutliers, FFTOutliers
...
class CovarianceOutliersTest(unittest.TestCase):
    ...
    def test_covarianceoutliers_predict_proba_gives_biggest_proba_to_biggest_outlier(self):
        ...
        outlier_index = np.argmax(probas.values)
