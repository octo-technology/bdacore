...
from bdacore.timeseries import MarkovSequenceMiner, TimeDurationSequenceMiner, MetaSequenceMiner
...
class TestMarkovSequenceMiner(unittest.TestCase):
    def test_chained_probas_with_transition_proba_matrix_prefilled(self):
        ...
        self.assertEqual(round(proba_vector[0], 3), values_to_obtain[0])
        self.assertEqual(round(proba_vector[1], 3), values_to_obtain[1])
        self.assertEqual(round(proba_vector[2], 3), values_to_obtain[2])
    ...
    def test_fit_predict_proba_simple_markov_chain_should_return_correct_values(self):
        ...
        self.assertEqual(round(y[0], 3), y_true[0])
        self.assertEqual(round(y[1], 3), y_true[1])
        self.assertEqual(round(y[2], 3), y_true[2])
