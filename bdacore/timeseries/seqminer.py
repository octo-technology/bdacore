...
from bdacore.timeseries import HistogramData
...
class MarkovSequenceMiner(BaseEstimator):
    ...
    Examples
    -------- 
    >>> from bdacore.timeseries import MarkovSequenceMiner
...
class TimeDurationSequenceMiner(BaseEstimator):
    ...
    --------
    >>> import pandas as pd
    >>> from bdacore.timeseries import TimeDurationSequenceMiner
