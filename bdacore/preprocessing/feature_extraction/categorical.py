...
__version__ = "1.0"
__email__ = "vle@octo.com, ebi@octo.com"
...
class CategoricalProjector(BaseEstimator, TransformerMixin):
    ...
    --------
    >>> import pandas as pd
    >>> from bdacore.preprocessing.feature_extraction import CategoricalProjector
...
class TagEncoder(BaseEstimator, TransformerMixin):
    ...
    --------
    >>> import pandas as pd
    >>> from bdacore.preprocessing.feature_extraction import TagEncoder
